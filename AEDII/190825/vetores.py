...
arquivo.salvar_txt(vetor1, './AEDII/190825/data/vetor1.txt')
...
arquivo.salvar_txt(vetor2, './AEDII/190825/data/vetor2.txt')
...
arquivo.salvar_txt(vetor3, './AEDII/190825/data/vetor3.txt')